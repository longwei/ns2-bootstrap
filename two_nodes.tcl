...
set val(x)          5000   	;# X dimension of the topography
set val(y)          5000   	;# Y dimension of the topography
...
#$agent_(0) CreatePolicy $val(OkNeighbor) 1 0.7 0.0 $val(stop) 0 $val(true)
#$agent_(1) CreatePolicy $val(OkNeighbor) 0 0.7 0.0 $val(stop) 1 $val(true)
